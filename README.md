...
| 拒答正确率 | **1.00** |
| 引用有效率 | **1.00** |
| RAGAS Faithfulness | 0.62 → **0.77**（提升来自 prompt 收紧；重排对忠实度无贡献，但 Recall@5 +3.6pt） |
| RAGAS AnswerRelevancy | 0.40（中文 judge 噪声大，按 PLAN §5.3 需人工校准后采信） |

> 人工抽查发现：低分答案是**正确拒答**而非编造（拒答措辞天然不在原文中，被 judge 低估）。
